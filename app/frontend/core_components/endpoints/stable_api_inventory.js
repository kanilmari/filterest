...
const STABLE_CANDIDATE_ROUTE_SPECS = Object.freeze({
    ...
    adminConfiguration: Object.freeze([
        ...
        { routeName: 'adminLangKey', handlerName: 'lang.AdminLangKeyHandler' },
        ...
        { routeName: 'adminRowGroups', handlerName: 'system_table_tools.AdminRowGroupsHandler' },
        { routeName: 'adminRowGroupMemberships', handlerName: 'system_table_tools.AdminRowGroupMembershipsHandler' },
        { routeName: 'adminRowAccessRules', handlerName: 'system_table_tools.AdminRowAccessRulesHandler' },
        ...
        { routeName: 'saveSiteViewFieldSet', handlerName: 'system_table_tools.SaveSiteViewFieldSetHandler' },
        { routeName: 'assignSiteViewFieldSet', handlerName: 'system_table_tools.AssignSiteViewFieldSetHandler' },
        { routeName: 'resetSharedViewFieldSet', handlerName: 'system_table_tools.ResetSharedViewFieldSetHandler' },
        { routeName: 'deleteSharedViewFieldSet', handlerName: 'system_table_tools.DeleteSharedViewFieldSetHandler' },
    ]),
    adminMaintenance: Object.freeze([
    ...
    authAndUser: Object.freeze([
        { routeName: 'getViewFieldSets', handlerName: 'system_table_tools.GetViewFieldSetsHandler' },
        { routeName: 'savePersonalDatasetSortDefault', handlerName: 'system_table_tools.SavePersonalDatasetSortDefaultHandler' },
        { routeName: 'savePersonalViewFieldSet', handlerName: 'system_table_tools.SavePersonalViewFieldSetHandler' },
        { routeName: 'assignPersonalViewFieldSet', handlerName: 'system_table_tools.AssignPersonalViewFieldSetHandler' },
        { routeName: 'resetPersonalViewFieldSet', handlerName: 'system_table_tools.ResetPersonalViewFieldSetHandler' },
        { routeName: 'deletePersonalViewFieldSet', handlerName: 'system_table_tools.DeletePersonalViewFieldSetHandler' },
