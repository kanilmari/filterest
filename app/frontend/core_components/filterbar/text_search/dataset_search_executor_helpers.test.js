...
describe("dataset_search_executor_helpers", () => {
    ...
    test("semantic newest orders database-version rows by applied_at and then id", () => {
        const rows = [
            { id: 1, applied_at: "2026-08-21T23:44:00Z", version: "9.2.5" },
            { id: 2, applied_at: "2026-08-23T23:56:00Z", version: "8.0.50" },
            { id: 3, applied_at: "2026-08-23T23:56:00Z", version: "9.6.4" },
        ];

        expect(sortRows(rows, "__newest", "DESC", {
            id: "integer",
