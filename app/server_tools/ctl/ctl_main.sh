...
#
# Unified management tool for Filterest instances, Docker, and Traefik.
#
# Usage:
...
───────────────────────────────────────────────────────────────────────────────
Jokainen instanssi on erillinen Filterest-asennus omalla tietokannalla.
Instanssit sijaitsevat kansiossa: ./instances/<nimi>/
  ...
  ./ctl --instance create mgmt.local --role management
                                    Luo hallinta-Filterestin management-seedillä

Käynnistys:
  ./ctl --instance serlog.com       Käynnistä serlog.com-instanssi
  ./ctl --instance example.com      Käynnistä example.com (ngrok automaattisesti)
