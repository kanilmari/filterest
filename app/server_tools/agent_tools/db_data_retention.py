...
try:
    from .easelect_api_client import authenticated_api_request
except ImportError:
    from easelect_api_client import authenticated_api_request
...
def cmd_preview(args):
    ...
    payload = authenticated_api_request(
        "GET",
...
def cmd_prune(args):
    ...
    preview = authenticated_api_request(
        "GET",
        "/api/data-retention/preview",
        query=preview_params or None,
    )
    print("Preview:")
