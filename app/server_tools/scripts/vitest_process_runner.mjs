...
function resolveDefaultVitestEntrypoint() {
  const configuredNodeModulesRoot = process.env.FILTEREST_NODE_MODULES_ROOT?.trim();
  if (configuredNodeModulesRoot) {
    return resolve(configuredNodeModulesRoot, 'vitest/vitest.mjs');
  }
