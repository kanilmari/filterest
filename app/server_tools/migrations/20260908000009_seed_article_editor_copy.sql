...
-- Seeds the generic multilingual article field editor interface copy.
-- Bridges incremental upgrades and the independently generated public bootstrap.
-- Keeps site-authored translations and existing data unchanged.
-- VERSION_DB: 9.7.12
...
SELECT '9.7.12', 'Seed generic multilingual article editor copy'
WHERE NOT EXISTS (SELECT 1 FROM public.system_db_version WHERE version = '9.7.12');
