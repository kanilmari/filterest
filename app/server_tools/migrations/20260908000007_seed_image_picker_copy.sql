...
-- Seeds web-image picker help and the unambiguous original-page link.
-- Bridges upgraded databases and the standalone public language bootstrap.
-- Keeps site-authored copy and the browser clipboard security model intact.
-- VERSION_DB: 9.7.10
...
SELECT '9.7.10', 'Seed reviewed web-image picker and clipboard help text'
WHERE NOT EXISTS (SELECT 1 FROM public.system_db_version WHERE version = '9.7.10');
