...
var RouteProfiles = map[string]RouteProfile{
	...
	"system_table_tools.GetSitePresentationSettingsHandler": PublicProfile,
	...
	"dtt_1_row_read.ChatAttachmentHandler":        AdminProfile,
	...
	"system_table_tools.GetViewFieldSetsHandler":               LoginOnlyProfile,
	"system_table_tools.SavePersonalDatasetSortDefaultHandler": LoginOnlyProfile,
	"system_table_tools.SavePersonalViewFieldSetHandler":       LoginOnlyProfile,
	"system_table_tools.AssignPersonalViewFieldSetHandler":     LoginOnlyProfile,
	"system_table_tools.ResetPersonalViewFieldSetHandler":      LoginOnlyProfile,
