...
//
// Like the fingerprint binding, the device cookie is written at sign-in and lives
// seven days, so a long-absent person can return with a readable session and no
// binding. session_expiry.RespondSignInNoLongerValid owns that answer for the
// whole application.
