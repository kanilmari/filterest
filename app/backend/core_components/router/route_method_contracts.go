...
var explicitRouteMethodContracts = map[string]RouteMethodContract{
	...
	"auth.SiteAssistantDelegationExchangeHandler": {Methods: []string{http.MethodPost}, Source: RouteMethodSourceExplicitStableContract},
	...
	"lang.AdminLangKeyHandler":                    {Methods: []string{http.MethodPost}, Source: RouteMethodSourceExplicitStableContract},
	...
	"dtt_1_row_read.ChatAttachmentHandler":                   {Methods: []string{http.MethodPost}, Source: RouteMethodSourceExplicitStableContract},
	...
	"system_table_tools.UpdateColumnInsertableHandler":         {Methods: []string{http.MethodPost}, Source: RouteMethodSourceExplicitStableContract},
	...
	"system_table_tools.DeletePersonalViewFieldSetHandler":     {Methods: []string{http.MethodPost}, Source: RouteMethodSourceExplicitStableContract},
	"system_table_tools.SaveSiteViewFieldSetHandler":           {Methods: []string{http.MethodPost}, Source: RouteMethodSourceExplicitStableContract},
	"system_table_tools.AssignSiteViewFieldSetHandler":         {Methods: []string{http.MethodPost}, Source: RouteMethodSourceExplicitStableContract},
	"system_table_tools.DeleteSharedViewFieldSetHandler":       {Methods: []string{http.MethodPost}, Source: RouteMethodSourceExplicitStableContract},
	...
	"system_table_tools.SavePersonalDatasetSortDefaultHandler": {Methods: []string{http.MethodPost}, Source: RouteMethodSourceExplicitStableContract},
