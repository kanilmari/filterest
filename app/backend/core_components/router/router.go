...
func RegisterRoutes(frontendDir string, storagePath string) {
	...
	functionRegisterHandler("/system/automation-account", systemAutomationAccountHandler, "router.systemAutomationAccountHandler")
	...
	functionRegisterHandler("/api/user-visual-preference", auth.UserVisualPreferenceHandler, "auth.UserVisualPreferenceHandler")
	...
	functionRegisterHandler("/api/dataset-sort-default/personal", system_table_tools.SavePersonalDatasetSortDefaultHandler, "system_table_tools.SavePersonalDatasetSortDefaultHandler")
	...
	functionRegisterHandler("/api/ui-languages", lang.GetPublicUILanguagesHandler, "lang.GetPublicUILanguagesHandler")
