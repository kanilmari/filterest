...
func TestDropTableHandlerRejectsInvalidRequestsBeforeDatabaseWork(t *testing.T) {
	tests := []struct {
		...
		{name: "missing confirmation", method: http.MethodPost, body: `{"dataset_name":"users"}`, wantStatus: 400, wantBody: "confirm_dataset_name"},
		{name: "wrong confirmation", method: http.MethodPost, body: `{"dataset_name":"users","confirm_dataset_name":"other"}`, wantStatus: 400, wantBody: "confirm_dataset_name"},
		{name: "display label is not name", method: http.MethodPost, body: `{"dataset_name":"users","confirm_dataset_name":"Users"}`, wantStatus: 400, wantBody: "confirm_dataset_name"},
		{name: "whitespace is not exact", method: http.MethodPost, body: `{"dataset_name":"users","confirm_dataset_name":" users " }`, wantStatus: 400, wantBody: "confirm_dataset_name"},
		{
