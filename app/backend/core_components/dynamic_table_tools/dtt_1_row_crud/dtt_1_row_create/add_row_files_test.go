...
func TestCurrentUploadStorageRootUsesConfiguredRuntimePath(t *testing.T) {
	...
	if got := currentUploadStorageRoot(); got != paths.StorageRoot {
		t.Fatalf("currentUploadStorageRoot() = %q, want %q", got, paths.StorageRoot)
	}
}
