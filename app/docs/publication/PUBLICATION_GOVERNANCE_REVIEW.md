...
- Governance documents preserve stable exact-evidence gates, manual-final review, and standing gated publication authorization without readiness overclaims.
...
- THIRD_PARTY_NOTICES.md and its manifest-bound license bundle retain exact owner-accepted hashes; final readiness fails if either changes.
