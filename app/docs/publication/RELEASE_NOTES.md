...
Filterest 9.3.11 reduces image and page-load network work, keeps article position across reloads and fixes local session and translation issues. Database compatibility remains 9.7.15; this release requires no schema migration.
