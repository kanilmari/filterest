...
import { resolveFilterestTestRuntimePaths } from '../e2e/helpers/test-runtime-paths';

export const VISUAL_GUARDIAN_OUTPUT_DIR = resolveFilterestTestRuntimePaths().visualGuardian;
