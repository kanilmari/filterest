...
LOGIN_TEMPLATE = PUBLIC_SOURCE_ROOT / "frontend" / "templates" / "login.html"
PRIVATE_GENERATOR_LANG_SEED = (
    PUBLIC_SOURCE_ROOT
    / "server_tools/public_bootstrap/source/app_tables.lang_keys.sql"
)
GENERATED_PUBLIC_LANG_SEED = (
    PUBLIC_SOURCE_ROOT / "server_tools/public_bootstrap/seed_data.sql"
)
PUBLIC_LANG_SEED = (
    PRIVATE_GENERATOR_LANG_SEED
